...
--drop Grades from previous table, define foreign key
...
gradesTable.assignment1, gradesTable.assignment2, gradesTable.TotalPoints, gradesTable.Studentaverage, finalGradesTable.Grade
FROM ((studentTable
